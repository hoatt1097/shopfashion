...
<html lang="en">
  ...
  <div class="container" style="margin-top: -80px">
    <div id="news-container">
      <h1><b>THỜI TRANG</b></h1>
     <div id='noidung'> 
            <div id="newest" class="row">
      <?php
       $dt->select('SELECT * from bangtin where idnhom = 1 order by idtin desc limit 1');
       if ($r=$dt->fetch()){
         $id=$r['idtin'];
         $idn=$r['idnhom'];
         $tieude=$r['tieude'];
      ...
      <?php
       ...
       <?php
       $dt->select("SELECT * from bangtin where idnhom = 1 and idtin !='$id' order by ngaydang desc limit 10");
        while ($r=$dt->fetch()){
         $id=$r['idtin'];
         $idn=$r['idnhom'];
         $tieude=$r['tieude'];
