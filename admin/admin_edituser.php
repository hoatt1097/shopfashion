<?php 
  ...
  $dt = new Database;
  $id = $_GET["id"];
  $dt -> select("SELECT * FROM user WHERE iduser = $id");
  while( $r = $dt->fetch())
  {
    $email = $r["email"];
...
">
    <title>Admin_edituser</title>

    <!-- Bootstrap -->
    <link rel="stylesheet" type="text/css" href="css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="css/bootstrap-theme.min.css">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css">
    <link rel="stylesheet" type="text/css" href="admin_edituser.css">
              ...
              <ul>
                ...
                <li><a class="list-group-item user-management" href="#" ><i class="fa fa-users fa-fw" aria-hidden="true"></i>&nbsp; Quản lý người dùng</a>
                  <ul class="menu-usesmanagement" >
                    ...
                    <li><a class="list-group-item roles child" href=""><i class="fa fa-genderless fa-fw" aria-hidden="true"></i>&nbsp; Admin</a>
                  </ul>
                </li>
