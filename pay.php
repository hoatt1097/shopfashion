        ...
        <div class="sidebar__content">
          ...
          <div class="form-group clearfix ">
            <div class="field__input-btn-wrapper mt10">
                ...
                <input type="submit" class="btn btn-primary btn-checkout" value="ĐẶT HÀNG" button"="">
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="section">
                ...
                <div class="section__content">    
                          <div class="form-group">
                              ...
                              <input class="field__input form-control" id="email" data-error="Vui lòng nhập email" required="" type="email">
                          </div>      
                          <div class="form-group">
                              <span class="field__label">
                                Họ và tên
                              </span>
                              <input class="field__input form-control" id="name" data-error="Vui lòng nhập họ tên" required="" type="text">
                          </div>                    
                          <div class="form-group">
                              <span class="field__label">
                                Số điện thoại
                              </span>
                              <input class="field__input form-control" id="phone" data-error="Vui lòng nhập số điện thoại" required="" type="text">
                          </div>                        
                          <div class="form-group">
                              <span class="field__label">
                                Địa chỉ
                              </span>
                              <input class="field__input form-control" id="address" data-error="Vui lòng nhập địa chỉ" required="" type="text">
                          </div>    
              ...
              <div class="section payment-methods">
                ...
                <div class="section__content">
                  <div class="content-box">
                    ...
                    <div class="radio-wrapper content-box__row content-box__row--secondary" id="payment-gateway-subfields-164203">
